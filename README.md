# Apache Phoenix/Hbase 訓練課程

## 投影片
- https://www.slideshare.net/secret/J40NHB8nLetJzJ


## 安裝步驟

### HDFS 安裝
- https://github.com/ywchiu/phoenix/blob/master/install_hdfs.md

### HBase 安裝
- https://github.com/ywchiu/phoenix/blob/master/install_hbase.md
